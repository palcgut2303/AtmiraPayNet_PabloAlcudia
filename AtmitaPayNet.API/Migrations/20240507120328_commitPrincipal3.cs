...
{
    /// <inheritdoc />
    public partial class commitPrincipal3 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CountryBankAccount = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CurrencyBankAccount = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IBANBankAccount = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InterBankId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentLetters_DestinationBankId",
                table: "PaymentLetters",
                column: "DestinationBankId");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentLetters_InterBankId",
                table: "PaymentLetters",
                column: "InterBankId");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentLetters_OriginBankId",
                table: "PaymentLetters",
                column: "OriginBankId");
        }
